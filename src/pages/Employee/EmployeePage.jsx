            ...
            <div className="md:flex md:justify-between md:items-center">
              <div className="p-4 flex justify-between items-center">
                ...
                <div className="border border-gray-100 rounded-lg overflow-clip">
                  <img
                    className="block mx-auto h-28 p-1 rounded-2xl sm:max-0 sm:shrink-0"
                    src="https://i.ibb.co/PxHFLB3/passport-thumbsize.jpg"
                    alt="John Doe"
                  />
                </div>
                ...
                <div className="font-poppins *:pb-2">
                  ...
                  <div className="flex space-x-2 items-center">
                    ...
                    <p className="font-medium text-sm text-gray-900">
                      {employeeData.profile[0].designation}
                    </p>
                  </div>
                  <div className="flex space-x-2 items-center">
                    <HiOutlineEnvelope className="text-gray-800 text-xl" />
                    <p className="font-medium text-sm text-gray-800">
                      {employeeData.profile[0].workEmail}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-end pr-4 pb-6 md:self-end">
                <button className="bg-[#7152f3] rounded-lg">
                  <div className="py-2 px-3">
                    ...
                    <span className="font-lexend text-white text-sm font-thin">
                      Edit Profile
                    </span>
                  </div>
                </button>
           ...
           ${
            ...
            >
              <div className="*:pl-4 md:*:pr-20 *:font-lexend *:text-gray-800 *:py-3 cursor-pointer overflow-hidden">
                <div
                  role="button"
                  onClick={() => handleChangeLink(1, 'profile')}
                  className={`${
                    activeLink === 1
                      ? "bg-[#7152f3] *:text-white hover:bg-[#7152f3]"
                      : ""
                  }
                ...
                <div
                  role="button"
                  onClick={() => handleChangeLink(2, 'attendance')}
                  className={`${
                    activeLink === 2
                      ? "bg-[#7152f3] overflow-hidden *:text-white hover:bg-[#7152f3]"
                      : ""
                  }
                      hover:bg-gray-100 md:whitespace-nowrap`}
                >
                ...
                <div
                  role="button"
                  onClick={() => handleChangeLink(3, 'projects')}
                  className={`${
                    activeLink === 3
                      ? "bg-[#7152f3] *:text-white hover:bg-[#7152f3]"
                      : ""
                ...
                <div
                  role="button"
                  onClick={() => handleChangeLink(4, 'leave')}
                  className={`${
                    activeLink === 4
                      ? "bg-[#7152f3] *:text-white hover:bg-[#7152f3]"
                      : ""
            ...
            <div className="mx-4">
              {tab === "profile" && <EmployeeProfile employeeDetails={employeeData} />}
              {tab === "attendance" && <EmployeeAttendance employeeDetails={employeeData} />}
            </div>
          </div>
        </div>
      </div>
