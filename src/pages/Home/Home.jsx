      ...
      <section className="w-full max-w-md md:max-w-lg lg:max-w-xl bg-white bg-opacity-90 p-6 rounded-lg shadow-lg flex items-center justify-center">
        <div className="w-full h-full flex flex-col justify-center items-center">
          <div className="flex w-full gap-2 items-center justify-center mb-6">
            ...
            <div className="font-bold text-2xl text-center font-lexend">Oasis People HRM</div>
          </div>
          <div>
          <div className="font-bold text-2xl text-center flex gap-2 font-lexend">Welcome <MdOutlineWavingHand className="mt-1 text-[#A86232]" /></div>
          </div>
          <div>
          <div className="text-sm text-center mt-4 flex gap-2 font-lexend font-thin">Please login here</div>
          </div>
          <form className="w-full sm:w-[90%] mt-4" onSubmit={loginFormik.handleSubmit}>
            <div className="mb-4">
              <input
                type="text"
                id="loginKey"
            ...
            <div className="mb-4">
              ...
              <div className='text-sm mt-1 mr-2 text-[#7152F3 hover:text-[#7152F3] hover:cursor-pointer'><em>Forgot Password?</em></div>
              </div>
            </div>
            <button
              type="submit"
